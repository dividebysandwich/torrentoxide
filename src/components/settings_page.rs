...
fn CategoriesSection() -> impl IntoView {
    ...
    view! {
        <section class="panel settings-section">
            ...
            <p class="settings-hint">
                "Map a category to a sub-folder under the media root (LIBRARY_ROOT) — e.g. a \"TV Shows\" folder directly under it. This is where the library lives and where categorized downloads are organized. New downloads can target a category, and the torrent list can be filtered by it."
            </p>
            <div class="cat-form">
                <input
